...
const DownloadMedia: React.FC = () => {
  ...
  return <PageContainer title='无水印下载'>
    ...
    <View className='margin-top width-9 text-gray text-sm'>
    ...
    <ButtonAsync onClick={submit} type='primary' className='margin-top width-8'>提交无水印内容，需消耗{getContentWithoutWatermark}<Logo /></ButtonAsync>
  </PageContainer>
}
